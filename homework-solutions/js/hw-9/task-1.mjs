...
// 1
let keyWithFourChars = Object.keys(character).filter((character) => character.length === 4);

// 2
let stringValues = Object.values(character).filter(character => typeof character === "string");
...
// console.log(keyWithFourChars, stringValues, hasSalaryKey1stOption, hasSalaryKey2ndOption)
